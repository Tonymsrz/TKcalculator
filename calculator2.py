...
btn_sqrt.grid(row=5, column=5, padx=4, pady=2)
...
btn_1x = tk.Button(root, text='1/x', width=5, font=font_16, relief=tk.FLAT, bg='#b1b2b2')
...
btn_1x.grid(row=6, column=5, padx=4, pady=2)
